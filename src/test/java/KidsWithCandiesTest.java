...
import leetcode.automaniac.KidsWithCandies;
...
public class KidsWithCandiesTest {
    ...
    public void example1() {
        ...
        Object[] result = new KidsWithCandies().kidsWithCandies(candies, extraCandies).toArray();

        for (int i = 0; i < expected.length; i++) {
            Assert.assertEquals(expected[i], (boolean) result[i]);
        }
    }
